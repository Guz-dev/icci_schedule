    ...
    return (
        ...
        <div class="block fixed overflow-hidden w-[100%] h-[100%]">
          <div class="flex justify-center">
            <div class="flex flex-col items-center bg-white w-[350px] h-[350px] border-amber-400 border-4">
              ...
              <button onClick={() => {viewPopup(false)}} class="w-32 text-base bg-red-500 p-2 rounded-r text-center font-bold text-white hover:text-amber-300" >Salir</button>
              <button class="p-2 w-32 text-base bg-blue-500 rounded-l text-center font-bold text-white hover:text-amber-300">Añadir</button>
              </div>
            </div>
          </div>  
        </div>
